...
Namespace TreapVB
    ...
    Public Class Treap
        ...
        Public KeyMaxLen As Int32 '代表Key的字符串最长为多少，一般不用
        ...
        '/</summary>
        Public Function insert(ByRef key As IComparable, ByRef data As Object) As TreapNode
        ...
        '/<summary>
        Private Function InsertNode(ByVal node As TreapNode, _
        ...
        '/<summary>
        Public Function find(ByVal key As IComparable) As Object
        ...
        Public Overloads Function Equals(ByVal obj As Object) As Boolean
            ...
            If (Not (TypeOf obj Is Treap)) Then
                Return False
            End If
            ...
            Return (ToString().Equals((CType(obj, Treap)).ToString()))
