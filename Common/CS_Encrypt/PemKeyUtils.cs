...
namespace Funny {
    public class PemKeyUtils {
        ...
        /// <returns></returns>  
        public static string RSAEncrypt(string key_file, string encryptString) {
            try {
                byte[] PlainTextBArray;
                byte[] CypherTextBArray;
                string Result;

                string strKey = File.ReadAllText(key_file).Trim();
                byte[] aaa = DecodeOpenSSLPublicKey(strKey);
                RSACryptoServiceProvider rsa =  DecodeX509PublicKey(aaa);
        ...
        /// <returns></returns>  
        public static string RSADecrypt(string key_file, string decryptString) {
            try {
                ...
                string Result;
                RSACryptoServiceProvider rsa = DecodeRSAPrivateKey(DecodeOpenSSLPrivateKey(strKey));
