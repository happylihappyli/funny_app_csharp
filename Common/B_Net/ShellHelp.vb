...
Namespace Funny
    ...
    Public Class ShellHelp
        ...
        Public Shared Function Run_Shell(
                    ByVal host As String,
                ByVal iPort As Int32,
                ByVal pEncoding As Encoding,
            ...
            Try
                ...
                Dim strReturn As String = exec.RunCommand(strCommand, pEncoding)

                'Dim strSplit() As String = strCommand.Split(vbLf)
                'For i As Int32 = 0 To strSplit.Length - 1
                '    If (strSplit(i).Trim() <> "") Then
                '        Dim strOut As String = "", strError As String = ""
                '        strReturn &= strSplit(i) & vbCrLf
                '        exec.RunCommand(strSplit(i), pEncoding, strOut, strError) ' ShellHelp.Run_Shell(strHost, iPort, username, Password, strFile_Private, strCommand) & vbCrLf
                '        strReturn &= strOut & vbCrLf & "======" & vbCrLf & strError & vbCrLf
                '    End If
                'Next
