...
function save_check_click(data){
    ...
    s_file.Ini_Save(disk+"\\Net\\Web\\main.ini","Code","Path_Data",path1);
    s_file.Ini_Save(disk+"\\Net\\Web\\main.ini","Code","Path_Index",path2);
    s_file.Ini_Save(disk+"\\Net\\Web\\main.ini","Code","Path_Seg",path3);
    s_ui.msg("保存成功！");
}

var Path_Data =s_file.Ini_Read(disk+"\\Net\\Web\\main.ini","Code","Path_Data");
var Path_Index=s_file.Ini_Read(disk+"\\Net\\Web\\main.ini","Code","Path_Index");
var Path_Seg  =s_file.Ini_Read(disk+"\\Net\\Web\\main.ini","Code","Path_Seg");
