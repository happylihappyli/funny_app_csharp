...
function b_recognize_click(data){
    var a=s_sys.SR_Recognize(disk+"123.wav");//,"result");//err_msg
    var obj = JSON.parse(a);
    var msg = obj.result[0];
    s_sys.Set_Text("txt1",msg);
...
function init(){
    ...
    s_sys.SR_Init(APP_ID,API_KEY,SECRET_KEY);
    s_ui.Button_Backgound("b_record","@recording");
}
