...
function train_click(data){
    ...
    var strMsg=python_bin+" /root/happyli/python/gbdt/gbdt_train.py /root/data/train.txt "+id+" "+count_field;
...
s_ui.panel_init("panel_middle",0,0,300,180,"bottom");
...
s_ui.button_init("b_next","下一步",350,500,200,30,"next_click","Run_Bat2\\step_test_gbdt");
...
s_ui.panel_add("panel_middle","progress2","top");
