...
function train_click(data){
    ...
    var strMsg=python_bin+" /root/happyli/python/gbdt/rf_train.py /root/data/train.txt "+id+" "+count_field;
...
s_ui.button_init("b_next","下一步",350,500,200,30,"next_click","Run_Bat2\\step_test_rf");
