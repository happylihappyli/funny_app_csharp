...
function static_click(data){
    ...
    switch(alg){
        case "KNN":
            cmd="python3 /root/happyli/python/gbdt/knn_test.py /root/test.txt "
            +id+" "+count_field+" /root/data/output.txt";
            break;
        case "GBDT":
            cmd="python3 /root/happyli/python/gbdt/gbdt_test.py /root/test.txt "
            +id+" "+count_field+" /root/data/output.txt";
            break;
        case "随机森林":
            cmd="python3 /root/happyli/python/gbdt/rf_test.py /root/test.txt "
            +id+" "+count_field+" /root/data/output.txt";
            break;
        case "逻辑回归":
            cmd=python_bin+" /root/test_lr_tcp.py /root/test.txt "
...
s_ui.font_size("lb_alg",18);
s_ui.font_size("cb_alg",18);
...
s_ui.panel_add("panel_middle_left","panel_middle_left_line1","top");
