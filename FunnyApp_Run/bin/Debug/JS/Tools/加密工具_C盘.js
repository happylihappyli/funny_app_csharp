...
function file_pem(){
    ...
    //s_ui.Run_App("explorer.exe","C:\\Net\\Web\\public\\");
}
...
function key_click(data){
    ...
    s_ui.Run_App("C:\\Windows\\System32\\OpenSSH\\ssh-keygen.exe"," -m PEM -t rsa -b 2048 -C test -f C:/Net/Web/id_rsa");
    s_ui.Text_Set("txt1","把这个文件 C:\\Net\\Web\\id_rsa.pub 发到服务器，让管理员设置");
}
...
s_ui.Text_Init("txt_file_public","C:/Net/Web/public/id_rsa_happyli.pub",100,10,500,30);
...
s_ui.Label_Init("lb_upload","加密公钥文件：",10,110);

s_ui.Text_Init("txt_file_public_pem","C:/Net/Web/public/pem/id_rsa_happyli.pem.pub",100,110,500,30);


s_ui.Label_Init("lb_upload","解密私钥文件：",10,150);
s_ui.Text_Init("txt_file_private","C:/Net/Web/id_rsa",100,150,500,30);


s_ui.Text_Init("txt_input","hello，你好",100,200,500,30);
s_ui.Button_Init("b3_1","加密",100,250,100,30,"encrypt_click","");
s_ui.Button_Init("b3_1","复制",300,250,100,30,"copy_click","");
s_ui.Button_Init("b3_1","解密",500,250,100,30,"decrypt_click","");
