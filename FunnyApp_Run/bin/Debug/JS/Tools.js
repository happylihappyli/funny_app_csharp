...
sys.Button_Init("b1_4","闹钟",500,50,100,30,"show_tools","闹钟");
sys.Button_Init("b1_5","聊天",650,50,100,30,"show_tools","聊天");

sys.Button_Init("b2_1","计算器",50,150,100,30,"show_tools","计算器");

sys.Button_Init("b2_2","draw",200,150,100,30,"draw_test","");
sys.Button_Init("b2_3","draw",350,150,100,30,"draw_test2","");
