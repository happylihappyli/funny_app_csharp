...
function send_msg_click(){
    ...
    s_file.append("C:\\Net\\Web\\log\\"+friend+".txt",
...
function event_chat(data){
    ...
    if (obj.type=="encrypt"){
        if (obj.to==userName){
            var strMsg=s_time.Time_Now()+" "+s_string.decrypt_private_key("C:/Net/Web/id_rsa",obj.message);
            s_file.append("C:\\Net\\Web\\log\\"+friend+".txt",s_time.Date_Now()+" "+strMsg+"\r\n");
            log_msg=strMsg+"\r\n"+"\r\n"+log_msg;
        }else{
            //log_msg="to="+obj.to+"\r\n"+"\r\n"+log_msg;
        }
